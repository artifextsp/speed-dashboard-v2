    ...
    try {
      ...
      onResult?.(
        result.initialized
          ...
          : `Sitio actualizado: ${stats.totalCount} clases listadas, ${stats.accessibleCount} con acceso, ${stats.pdfCount} PDF(s), ${stats.lockedCount} planeada(s) bloqueada(s). Espera 1–2 min y recarga proyectospeed.com con Cmd+Shift+R. Busca en el código fuente: SPEED build: 2026-06-24-pdf-v5`,
        false,
        result
      );
    } catch (err) {
